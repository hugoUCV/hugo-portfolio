  ...
  const TRANSLATIONS = {
    es: {
      ...
      page: {
        ...
        images: 'imágenes', share: 'Compartir', shared: 'Enlace copiado',
        zoomHint: 'Clic para zoom · arrastra para mover', kbd: 'cambia de proyecto',
        cine: 'Modo cine',
        cmd: { ph: 'Buscar o saltar a…', theme: 'Cambiar tema', vcard: 'Descargar contacto', email: 'Escríbeme', proj: 'Proyecto', sec: 'Sección', lang: 'Idioma', empty: 'Sin resultados' },
      },
    ...
    en: {
      ...
      page: {
        ...
        images: 'images', share: 'Share', shared: 'Link copied',
        zoomHint: 'Click to zoom · drag to move', kbd: 'switch project',
        cine: 'Cinema mode',
        cmd: { ph: 'Search or jump to…', theme: 'Toggle theme', vcard: 'Download contact', email: 'Email me', proj: 'Project', sec: 'Section', lang: 'Language', empty: 'No results' },
      },
    ...
    va: {
      ...
      page: {
        ...
        images: 'imatges', share: 'Compartir', shared: 'Enllaç copiat',
        zoomHint: 'Clic per fer zoom · arrossega per moure', kbd: 'canvia de projecte',
        cine: 'Mode cine',
        cmd: { ph: 'Cerca o salta a…', theme: 'Canviar tema', vcard: 'Descarregar contacte', email: 'Escriu-me', proj: 'Projecte', sec: 'Secció', lang: 'Idioma', empty: 'Sense resultats' },
      },
